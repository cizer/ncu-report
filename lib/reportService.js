...
var generate = function (configuration, upgraded, installedPackages) {
    ...
    var installedDependencies = packageParser.parse(installedPackages, "current");

    var mergedList = packageParser.merge(installedDependencies, upgradedVersions);
